...
'---'                       \\   \\  /   \\   \\  /   `----'              
    ...
    if passed_check:
        ...
        print(f"6. {'[Y] ' if change_region_enabled else ''}Change region to China (for J/A device, mutable camera shutter)")
        print("\n9. Apply")
        print("0. Exit\n")
        ...
        if page == 1:
            ...
            change_region_enabled = not change_region_enabled
        elif page == 9:
            print()
            ...
            if change_region_enabled:
                plist["CacheExtra"]["h63QSdBCiT/z0WU6rdQv6Q"] = "C"
